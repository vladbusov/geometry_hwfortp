...
//#include <Windows.h>
#define Pi 3.14
/* Реализовать абстрактный базовый класс «Фигура», содержащий методы вычисления площади и метод show() для отображения информации об объекте. Построить производные классы Square (квадрат), Circle (окружность), Rectangle (прямоугольник), содержащие методы для 
6 
 
вычисления площади фигур. Создать массив указателей на объекты базового класса и заполнить этот массив объектами производных классов. Продемонстрировать работу виртуальных методов базового класса при проходе по этому массиву.  */ 
